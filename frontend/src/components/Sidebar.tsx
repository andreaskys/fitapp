    ...
    return (
        <aside className="w-72 h-[calc(100vh-2rem)] m-4 hidden md:flex flex-col fixed left-0 top-0 bg-white/70 backdrop-blur-xl border border-white/20 shadow-2xl shadow-black/5 rounded-3xl z-50 p-6">
            <div className="px-4 py-8">
                <h1 className="text-xl font-semibold tracking-tight italic">Clinic.</h1>
            </div>
            ...
            {/* NEW: Global Account Actions Container positioned at the bottom */}
            <div className="mt-auto flex flex-col gap-1 border-t border-zinc-100 pt-4">
                ...
                <button
                    ...
                    className="flex items-center gap-3 px-4 py-3 text-zinc-400 hover:text-red-500 hover:bg-red-50 transition-colors rounded-xl group w-full text-left"
                >
